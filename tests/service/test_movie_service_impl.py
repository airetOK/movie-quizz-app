...
def mock_client():
    ...
    movie_api_client.get_image_url_by_movie_id = Mock(return_value="/test_image_path.jpg")
...
def test_get_five_random_movies(mock_client):
    ...
    assert movie_service.get_five_random_movies()[0].get_image_url() == "/test_image_path.jpg"
