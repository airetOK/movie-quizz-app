...
class Quizz():
    ...
    def __init__(self, id, correct_movie, option_movie_1,
        ...
        self.id = id
        self.question = self.QUESTION_TEMPLATE.format(
            correct_movie.get_title())
    ...
    def get_shuffled_option_movies(self):
        option_movies = [self.option_movie_1, self.option_movie_2,
                         self.option_movie_3, self.option_movie_4,
                         self.option_movie_5]
